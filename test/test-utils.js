...
const getCredentialObj = (data) => {
    ...
    ({0:credential._issuer, 1:credential._description, 2:credential._name, 3:credential._image, 
        4:credential._version, 5:credential._json, 6: credential._expires, 7: credential._recipient, 8: credential._txKey} = data);
    return credential;
}

const getBadgeObj = (data) => {
    let badge = {};
    ({0:badge._issuer, 1:badge._description, 2:badge._name, 3:badge._image, 4:badge._version, 5:badge._json} = data);
    return badge;
}
